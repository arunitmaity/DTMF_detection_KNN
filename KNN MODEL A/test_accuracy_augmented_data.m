...
disp('done result');
cm1 = confusionchart(result.Actual,result.Predicted,'title','Test Accuracy for KNN Model using Goertzel features without secondary harmonics (with augmented dataset)');
