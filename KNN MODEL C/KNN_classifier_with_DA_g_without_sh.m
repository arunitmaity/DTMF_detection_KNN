...
trainedClassifier = fitcknn(predictors,response,'NumNeighbors',16,'Distance','correlation', ... 
...
figure
cm = confusionchart(features.Label,validationPredictions,'title','Validation Accuracy for KNN Model (trained using augmented dataset) using Goertzel features without second harmonics');
...
cm1 = confusionchart(result.Actual,result.Predicted,'title','Test Accuracy for KNN Model (trained using augmented dataset) using Goertzel features without second harmonics');
